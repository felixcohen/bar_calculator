...
RSpec.describe BusinessesController, type: :controller do
  ...
  describe "GET index" do
    it "assigns all businesses products as @products" do
      ...
      product.save
      get :index, {} 
      expect(assigns(:products)).to include(business.products)
    end
  end
  ...
  describe "POST add_user" do
    it "emails a new a new user for the logged in admins business" do
      business = create(:business)
      expect(UserInviteMailer).to receive(:invite_email).with('test@felixcohen.co.uk', business)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested business" do
        ...
        expect_any_instance_of(Business).to receive(:update).with({ "name" => "MyString" })
