...
RSpec.describe TabsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created tab as @tab" do
        post :create, {:tab => valid_attributes}, valid_session
        expect(assigns(:tab)).to be_a(Tab)
        expect(assigns(:tab)).to be_persisted
      end

      it "redirects to the created tab" do
        post :create, {:tab => valid_attributes}, valid_session
        expect(response).to redirect_to(Tab.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved tab as @tab" do
        post :create, {:tab => invalid_attributes}, valid_session
        expect(assigns(:tab)).to be_a_new(Tab)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested tab" do
        tab = Tab.create! valid_attributes
        put :update, {:id => tab.to_param, :tab => new_attributes}, valid_session
        tab.reload
      ...
      it "redirects to the tab" do
        tab = Tab.create! valid_attributes
        put :update, {:id => tab.to_param, :tab => valid_attributes}, valid_session
        expect(response).to redirect_to(tab)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the tab as @tab" do
        tab = Tab.create! valid_attributes
        put :update, {:id => tab.to_param, :tab => invalid_attributes}, valid_session
        expect(assigns(:tab)).to eq(tab)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the tabs list" do
      tab = Tab.create! valid_attributes
      delete :destroy, {:id => tab.to_param}, valid_session
      expect(response).to redirect_to(tabs_url)
    end
  end
